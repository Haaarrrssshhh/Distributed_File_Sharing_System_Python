...
WORKER_ID = "worker_4"  # Change this for each worker instance
PORT = os.getenv("WORKER_4_PORT")  # Change this for each worker instance
...
WORKER_IP = os.getenv("WORKER_4_IP") 
