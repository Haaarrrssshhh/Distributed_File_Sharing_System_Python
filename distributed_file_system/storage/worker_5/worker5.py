...
WORKER_ID = "worker_5"  # Change this for each worker instance
PORT = os.getenv("WORKER_5_PORT")  # Change this for each worker instance
...
WORKER_IP = os.getenv("WORKER_5_IP")
